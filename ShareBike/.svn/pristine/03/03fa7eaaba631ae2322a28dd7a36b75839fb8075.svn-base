...
public class CountDownProgress extends View {
    ...
    private static int defaultCircleStrokeColor = Color.parseColor("#FFEF354F");
    private static int defaultCircleStrokeWidth = 4;
    private static int defaultCircleRadius = 50;
    private static int progressColor = Color.WHITE;
    ...
    private static int textColor = Color.parseColor("#FFEF354F");
    ...
    private static String textDesc = "15:00";
    private static long countdownTime;
    private static int mStartSweepValue = -90;
    private CountDownTimer timer;
    private ValueAnimator animator;
    private OnCountdownCancelListener countdownCancelListener = null;
    private boolean flag = true;

    public void setOnCountdownCancelListener(OnCountdownCancelListener onCountdownCancelListener) {
        this.countdownCancelListener = onCountdownCancelListener;
    }
...
//                textDesc = ((countdownTime / (1000 * 60)) + ":" + (countdownTime / 1000 % 60));
                textDesc = (millisUntilFinished / (1000 * 60) + ":" + (millisUntilFinished / 1000 % 60));
                Log.e("time", textDesc + "");
                //刷新view
                invalidate();
            }
    ...
    //倒计时的方法
    private void countdownMethodCancel() {
        if (timer != null) {
            timer.cancel();
            timer = null;
        }
    ...
    public void setCountdownTime(long countdownTime) {
        ...
        textDesc = "00:00";
        //  textDesc = ((this.countdownTime / (1000 * 60)) + ":" + (this.countdownTime / 1000 % 60));

    }


    public void setCountdownTimeCancel() {
        if (timer != null) {
            timer.cancel();
            flag = false;
        }
    ...
    public interface OnCountdownCancelListener {

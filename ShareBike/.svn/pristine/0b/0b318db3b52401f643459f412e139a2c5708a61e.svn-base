...
public class AMapUtil {
    ...
    public static String getFriendlyTimeForSecond(int second) {
        if (second > 3600) {
            int hour = second / 3600;
            int miniate = (second % 3600) / 60;
            int second1 = (second % 3600) / 60 / 60;
            return hour + "小时" + miniate + "分钟" + second1 + "秒";
        }
        if (second >= 60) {
            int miniate = second / 60;
            int second1 = second % 60;
            return miniate + "分钟" + second1 + "秒";
        }
        return second + "秒";
    }
    /**
     ...
     * @return
     */
    public static String getFriendlyLengthByMe(int lenMeter) {
        if (lenMeter > 10000) // 10 km
        {
            int dis = lenMeter / 1000;
            return dis + ChString.Kilometer;
     ...
     * @return
     */
    public static String getFriendlyTimeByMe(int second) {
        if (second > 3600) {
            int hour = second / 3600;
            int miniate = (second % 3600) / 60;
            return hour + "小时" + miniate + "";
        }
        if (second >= 60) {
            int miniate = second / 60;
            return miniate + "";

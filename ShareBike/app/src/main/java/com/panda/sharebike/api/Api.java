...
//    public static final String BASE_URL = "http://eefdt9.natappfree.cc/";
//    public static final String BASE_URL = "http://app.qiaoqidanche.com:81/";
    public static final String BASE_URLLL = "http://192.168.11.111:8080/";
    //public static final String BASE_URL = "http://app.qiaoqidanche.com:81/";
    public static final String BASE_URLL = "https://free-api.heweather.com/v5/";
    public static final String BASE_URL = "http://47.97.170.136:8080/";
   ...
   1. noCache 不使用缓存，全部走网络
    ...
    private Api() {
        ...
        Interceptor headerInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                Request build = chain.request().newBuilder()
                        // .addHeader(N.SHARE_TOKEN, SPUtils.getInstance(N.SHARE_TOKEN).getString(N.SHARE_TOKEN_KEY, ""))//无网络要配置token吗
        ...
        retrofit = new Retrofit.Builder()
                ...
                .baseUrl(BASE_URL)
                .build();
        //movieService = retrofit.create(ApiServices.class);
    }

...
public class RechargeProtocolActivity extends BaseActivity {
    ...
    protected int getLayoutView() {
        return R.layout.activity_rechargeprotocol;
    }
    ...
    private void initWebView() {
        ...
        mWebView.loadUrl(Api.BASE_URL + "qbike/kqweb/recharge.html");
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onReceivedTitle(WebView view, String title) {
                ...
                RechargeProtocolActivity.this.setTitle(title);
            }
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                Toast.makeText(RechargeProtocolActivity.this, "error", Toast.LENGTH_SHORT).show();

...
public class CustomTitleBar extends RelativeLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mIvLeft.setImageResource(left_button_imageId);
        mTvLeft.setText(left_button_text);

        mIvRight.setImageResource(right_button_image_id);
        mTvRight.setText(right_button_text);

...
public class PayPwdEditText extends RelativeLayout {
    ...
    private OnTextUnFinishListener onTextUnFinishListener;
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if(s.length() == pwdlength) {
                    ...
                    if(onTextUnFinishListener != null) {
                        onTextUnFinishListener.onUnFinish(s.toString().trim());
                    }
                }
            }
        });
    ...
    public void setOnTextUnFinishListener(OnTextUnFinishListener onTextUnFinishListener) {
        this.onTextUnFinishListener = onTextUnFinishListener;
    }
    ...
    public interface OnTextUnFinishListener {
        void onUnFinish(String str);
    }

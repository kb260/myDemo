...
public class FirstDraftFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener,
    ...
    public static FirstDraftFragment getInstance() {
        return new FirstDraftFragment();
    }

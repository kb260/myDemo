...
public class HandledFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener,
    ...
    public static HandledFragment getInstance() {
        return new HandledFragment();
    }

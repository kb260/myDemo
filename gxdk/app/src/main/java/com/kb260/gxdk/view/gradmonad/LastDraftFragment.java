 ...
 */
public class LastDraftFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener,
    ...
    public static LastDraftFragment getInstance() {
        return new LastDraftFragment();
    }

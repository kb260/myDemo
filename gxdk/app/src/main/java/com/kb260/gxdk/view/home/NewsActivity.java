...
import com.kb260.gxdk.adapter.NewsAdapter;
 ...
 */
public class NewsActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.RequestLoadMoreListener {
    @BindView(R.id.toolbar)
    Toolbar toolbar;
    @BindView(R.id.toolbarTitle)
    TextView toolbarTitle;
    @BindView(R.id.a_news_rv)
    RecyclerView rv;
    ...
    private void initData() {
        Api.getDefault().seltips(KBApplication.token,KBApplication.userid,page)

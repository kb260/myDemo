...
import com.kb260.gxdk.adapter.InformationAdapter;
...
import com.kb260.gxdk.view.home.InformationDetailActivity;
 ...
 */
public class InformationActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener,
        BaseQuickAdapter.RequestLoadMoreListener{
    @BindView(R.id.toolbar)
    Toolbar toolbar;
    @BindView(R.id.toolbarTitle)
    TextView toolbarTitle;
    @BindView(R.id.a_information_rv)
    RecyclerView rv;
    ...
    private void initData() {
        Api.getDefault().selmymessage(KBApplication.token,KBApplication.userid,page)
    ...
    private void initRv() {
        ...
        data = new ArrayList<>();
        adapter = new InformationAdapter(data);
